...
def on_mouse_move(x, y):
    ...
    with state.switching_lock:
        if state.active_screen == 'master':
            ...
            if edge:
                ...
                if result:
                    ...
                    if server.send(enter_msg):
                        ...
                        # Lock cursor to CENTER of master screen (not edge!)
                        # This gives room for mouse to move in any direction
                        state.edge_lock_x = state.screen_w // 2
                        state.edge_lock_y = state.screen_h // 2
            ...
            # Ignore the synthetic mouse event generated by our own cursor warp
            ...
            # Controlling remote server — compute deltas
            ...
            # Warp master cursor back to center to keep generating deltas
